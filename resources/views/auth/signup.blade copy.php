                ...
                <form id="registrationForm" action="{{ route('auth.register.signup') }}" method="POST">
                    ...
                    <div id="secondStep">
                        <div class="form-group my-3">
                            ...
                            <p id="date_of_birth-error" class="small text-danger" style="display:none">Please provide the date
                                you
                                were born</p>
                        </div>
                        <div class="form-group my-3">
                    ...
                    <div id="thirdStep">
                        <div class="form-group my-3">
                            ...
                            <input type="text" class="form-control" name="school_name"
                                ...
                                go to ?"
                                required>
                            <p id="school_name-error" class="small text-danger" style="display:none">What school do you go to ?</p>
                        </div>
                        <div class="form-group my-3">
