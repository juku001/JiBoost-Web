...
@section('content')
    <div class="content">
        <div class="container">
            <div class="row">
                ...
                {{-- <div class="offset-md-3 col-12 col-md-6 mt-5">
                    <div class="d-flex justify-content-between mx-auto  my-1" style="max-width: 400px;">
                        <div>
                            <span>Name</span>
                        </div>
                        <div>
    ...
    <script>
        function checkPaymentStatus() {
            fetch("{{ route('dashboard.subscription.wait', ['ref' => $ref]) }}", {
                    method: "GET",
                    headers: {
                ...
                .then(data => {
                    if (data.status === "success") {
                        ...
                        document.getElementById("status-gif").src =
                            "https://education.uoc.ac.in/images/ezgif.com-crop.gif"; // Success GIF
                        setTimeout(() => window.location.href = "{{ route('dashboard.home') }}",
                            3000); // Redirect after 3 sec
                    } else if (data.status === "failed") {
                        document.getElementById("payment-message").innerText = "Payment Failed!";
                        document.getElementById("status-gif").src =
                            "https://media.tenor.com/GL7cyMq1ad4AAAAC/payment-failed.gif"; // Failed GIF
                    }
